...
9. Duplicare un ordine Accepted della **giornata operativa corrente** (`NUOVO ORDINE DA QUESTO`, D-046 / ARCH-006 COMPLETE; conflitto DRAFT = D-047 / ARCH-007 COMPLETE).
...
- duplicazione Accepted giornata corrente → nuovo DRAFT (`NUOVO ORDINE DA QUESTO`, D-046 / ARCH-006 COMPLETE; conflitto DRAFT = D-047 / ARCH-007 COMPLETE);
